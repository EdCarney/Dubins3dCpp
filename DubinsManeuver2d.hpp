...
class DubinsManeuver2d
{
    ...
    DubinsManeuver2d _buildBasicManeuver(vector<double> qi, vector<double> qf, double rhoMin);
    ...
    public:
        ...
        DubinsManeuver2d();
        DubinsManeuver2d createDubinsManeuver2D(vector<double> qi, vector<double> qf, double rhoMin = 1, double minLength = -1, bool disableCCC = false);
